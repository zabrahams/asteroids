(function () {
  ...
  Game.prototype.drawBackground = function (ctx) {
    ...
    var stripeWidth = Game.DIM_X/colors.length;
    for ( i = 0; i < colors.length; i++) {
      ctx.fillStyle = colors[i];
      ctx.fillRect(0 + (stripeWidth*i), 0, stripeWidth, Game.DIM_Y);
    }
  };
  ...
  Game.prototype.drawRestartButton = function (ctx, radius, inner = Asteroids.Ship.INNER_COLOR, outer = Asteroids.Ship.COLOR) {
    ctx.fillStyle = inner;
